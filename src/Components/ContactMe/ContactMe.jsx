...
export default function ContactSectionFormik({
  ...
  const mailtoPrefill = `mailto:${email}?subject=Project%20Inquiry%20from%20Portfolio&body=Hi%20Jovani,%0A%0AMy%20project%20is%20about:%20...%0ABudget:%20...%0ATimeline:%20...%0A%0AThanks!`;
    ...
    {({ isSubmitting, errors, touched }) => (
      <Form className="space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-3 pt-2">
          ...
          <a
            href="mailto:jovanijohn40@gmail.com"
